...
if( MSVC )
  ...
  set(ASSIMP_LIBRARY_SUFFIX "_d-${MSVC_PREFIX}-mt" CACHE STRING "the suffix for the assimp windows library" FORCE)
else()
  set(ASSIMP_LIBRARY_SUFFIX "_d" CACHE STRING "the suffix for the openrave libraries" FORCE)
endif()
